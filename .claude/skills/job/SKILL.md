...
Tell the user `.agent-guild/state/spec.md` is ready and point them at `/constitution` — it collapses its interview into a confirm-and-adjust step when `spec.md` already exists, instead of running the full question bank.

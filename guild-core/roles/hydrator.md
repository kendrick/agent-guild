...
You run the five-phase AI-assisted hydration pipeline: discover, extract, draft, reconcile, propose. Each phase is a bundled skill named `hydrate-{discover,extract,draft,reconcile,propose}`, and that skill's instructions define the phase.

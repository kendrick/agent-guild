...
A PASS covers the text that was audited and nothing else. Edit a clause afterward and the gate closes again until a fresh PASS lands on the current document, so batch late revisions into one round rather than trickling them in after the verdict.
